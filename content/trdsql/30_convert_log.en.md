...
date = "2024-04-18"
description = "trdsql convert log"
weight = 30
tags = [
    "trdsql",
    "apache",
...
[mingrammer/flog](https://github.com/mingrammer/flog) makes it easy to output fake logs, so I'll show you how to convert the output logs to LTSV format.
